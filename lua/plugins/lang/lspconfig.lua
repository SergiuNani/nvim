...
local on_attach = function(client, bufnr)
    ...
    keymap.set("n", "<leader>dt", "<cmd>Telescope diagnostics bufnr=0<CR>", opts) -- show  diagnostics for file
    ...
    keymap.set("n", "<C-y>", vim.lsp.buf.hover, opts) -- show documentation for what is under cursor
end
